class Minfo < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tavril/minfo/releases/download/v0.20.0/minfo-v0.20.0-darwin-arm64.tar.gz"
      sha256 "4aa975778b3d22c22e79a05cb09c3df30e0226cf140521a149ebb85f56cdd855"
    end
    #on_intel do
    #end
  end
